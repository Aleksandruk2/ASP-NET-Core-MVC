...
{
    /// <summary>
    /// Мапер для перетворення елемента кошика (CartEntity)
    /// у модель для відображення (CartItemModel).
    /// Використовує пов’язані дані рейсу (Transportation),
    /// щоб заповнити інформацію про маршрут, часи поїздки,
    /// статус рейсу та кількість обраних квитків.
    /// </summary>
