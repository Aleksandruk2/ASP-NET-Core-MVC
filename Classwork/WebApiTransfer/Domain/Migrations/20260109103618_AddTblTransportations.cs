        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transportations_tblCities_FromCityId",
                        column: x => x.FromCityId,
                        principalTable: "tblCities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Transportations_tblCities_ToCityId",
                        column: x => x.ToCityId,
                        principalTable: "tblCities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Transportations_tblTransportationStatuses_StatusId",
                        column: x => x.StatusId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transportations_FromCityId",
                table: "Transportations",
                column: "FromCityId");

            migrationBuilder.CreateIndex(
                name: "IX_Transportations_StatusId",
                table: "Transportations",
                column: "StatusId");

            migrationBuilder.CreateIndex(
                name: "IX_Transportations_ToCityId",
                table: "Transportations",
                column: "ToCityId");
        }
